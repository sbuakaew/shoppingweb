...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 22, 2022 at 03:24 PM
...
(9, 'David Beckham', '', 'david@gmail.com', '111-222-3232', 230, 'CBN Street', 'NYC', 'NYC', '12022', '', '', '', 0, '', '', '', '', '', '', '', 0, '', '', '', '', 0, '81dc9bdb52d04dc20036dbd8313ed055', '', '2022-08-22 07:20:52', '1661174452', 1);
...
(6, 'Pant 1', '', '12', 5, 'product-featured-6.jpg', '', '', '', '', '', 75, 1, 1, 2),
...
--
-- Table structure for table `tbl_setting_preloader`
--

CREATE TABLE `tbl_setting_preloader` (
  `id` int(11) NOT NULL,
  `preloader_status` text COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `tbl_setting_preloader`
--

INSERT INTO `tbl_setting_preloader` (`id`, `preloader_status`) VALUES
(1, 'Off');
...
--
-- Indexes for table `tbl_setting_preloader`
--
ALTER TABLE `tbl_setting_preloader`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tbl_setting_preloader`
--
ALTER TABLE `tbl_setting_preloader`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
